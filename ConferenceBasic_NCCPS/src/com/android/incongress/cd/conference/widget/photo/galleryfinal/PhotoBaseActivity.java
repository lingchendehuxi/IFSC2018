...
import com.android.incongress.cd.conference.widget.photo.galleryfinal.utils.MediaScanner;
...
public abstract class PhotoBaseActivity extends Activity implements EasyPermissions.PermissionCallbacks{
    ...
    protected void takePhotoAction() {
        ...
        if (suc) {
            if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.N){
                mTakePhotoUri = FileProvider.getUriForFile(this, BuildConfig.APPLICATION_ID+".camera.fileprovider", toFile);
            }else {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if ( requestCode == GalleryFinal.TAKE_REQUEST_CODE ) {
            if (resultCode == RESULT_OK && mTakePhotoUri != null&&tempFile!=null) {

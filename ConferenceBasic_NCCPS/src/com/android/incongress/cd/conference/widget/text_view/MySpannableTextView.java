...
public class MySpannableTextView extends IconView {
    ...
    private void limitTextViewString(String textString, int maxFirstShowCharCount, final TextView textView, final View.OnClickListener clickListener) {
        ...
        int lastCharIndex = getLastCharIndexForLimitTextView(textView, textString, width, 2);
//返回-1表示没有达到行数限制
        ...
        mSpanALL.setSpan(new ClickableSpan() {
            ...
            public void updateDrawState(TextPaint ds) {
                ...
                ds.setColor(textView.getResources().getColor(R.color.theme_color));

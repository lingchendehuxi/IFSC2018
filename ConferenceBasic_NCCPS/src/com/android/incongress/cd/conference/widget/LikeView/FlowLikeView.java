package com.android.incongress.cd.conference.widget.LikeView;
...
public class FlowLikeView extends RelativeLayout {
    ...
    private void initParams() {
        ...
        mLikeDrawables.add(generateDrawable(R.drawable.professor_default));
        mLikeDrawables.add(generateDrawable(R.drawable.professor_default));
        mLikeDrawables.add(generateDrawable(R.drawable.professor_default));
        mLikeDrawables.add(generateDrawable(R.drawable.professor_default));
        mLikeDrawables.add(generateDrawable(R.drawable.professor_default));
    ...
    private void startAnimation(View target) {
        ...
        finalAnimatorSet.playSequentially(curveAnimator);
    ...
    private PointF generateCTRLPointF(int value) {
        ...
        pointF.x = mRandom.nextInt(100)-mViewWidth / 4+10;
        pointF.y = mRandom.nextInt(mViewHeight / value)+10;
...
//                    + ((float) Math.pow(fraction, 2)) * endValue.y;
    ...
    private class CurveUpdateLister implements ValueAnimator.AnimatorUpdateListener {
        ...
        public void onAnimationUpdate(ValueAnimator animation) {
            ...
            // 改变对象的透明度
            ViewCompat.setAlpha(target, 1.5f - animation.getAnimatedFraction());
        }
    }

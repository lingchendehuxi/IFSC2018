...
package com.android.incongress.cd.conference.widget.photo.galleryfinal.widget.crop;
        ...
        if (saveFile != null) {
            ...
            try {
                if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.N){
                    outputStream = getContentResolver().openOutputStream(FileProvider.getUriForFile(this, BuildConfig.APPLICATION_ID+".camera.fileprovider", saveFile));
                }else {
            ...
            if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.N){
                CropUtil.copyExifRotation(
                        ...
                        CropUtil.getFromMediaUri(this, getContentResolver(), FileProvider.getUriForFile(this, BuildConfig.APPLICATION_ID+".camera.fileprovider", saveFile))
                );
            }else {
                CropUtil.copyExifRotation(
                        CropUtil.getFromMediaUri(this, getContentResolver(), sourceUri),

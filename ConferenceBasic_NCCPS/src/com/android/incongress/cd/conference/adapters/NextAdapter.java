...
public class NextAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener{
    ...
    public NextAdapter(List<Session> sessions, String[] roleWithName, List<Class> classes, Map<Integer, List<Meeting>> meetingBySession, String currentDay, int[] currentHourAndMinute , Context context) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        NextAdapter.SessionViewHolder holder = new SessionViewHolder(view);
        return holder;
    }
    ...
    class MeetingAdapter extends BaseAdapter {
        ...
        private Set<Integer> nextPositions;

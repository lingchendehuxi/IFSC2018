...
public class QuestionsSquarAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private Context mContext;
    private List<MyMeetingQuestion.SceneShowArray2Bean> mAllQuestions;

    private static final int VIEW_TYPE_TITLE = 1;
    private static final int VIEW_TYPE_QUESTION = 2;

    public QuestionsSquarAdapter(Context context, List<MyMeetingQuestion.SceneShowArray2Bean> questions) {

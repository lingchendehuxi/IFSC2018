...
public class AllRoomsAdapter extends RecyclerView.Adapter<AllRoomsAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        if (bean.isSelect()) {
            ...
            PicUtils.setImageViewColor(holder.img, R.color.theme_color);
        ...
        if(AppApplication.systemLanguage == 1){
            ...
            holder.name.setText(bean.getClassCodeEn());
        }
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ViewHolder(View view) {
            super(view);
            name = view.findViewById(R.id.rooms_name);
            img = view.findViewById(R.id.is_select);

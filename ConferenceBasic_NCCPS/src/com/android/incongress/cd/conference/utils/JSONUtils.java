...
import com.android.incongress.cd.conference.http.HTTPSTrustManager;
import com.android.incongress.cd.conference.http.TrustAllSSLSocketFactory;
...
public class JSONUtils {
    ...
    public static String getString(JSONObject jsonObject, String key, String defaultValue) {
        ...
        try {
            if (jsonObject.getString(key) == JSONObject.NULL) {
                return null;
            }
